...
//--------------------------------------------------------------------------------------------------
void runHgll_2012_resync_ele(const char *fileset    = "0000",
...
//     hltModll->AddTrigger("HLT_Ele17_CaloIdT_TrkIdVL_CaloIsoVL_TrkIsoVL_Ele8_CaloIdT_TrkIdVL_CaloIsoVL_TrkIsoVL_v*",161217, 166967);  
  hltModll->AddTrigger("HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*",0, 196531);
...
//   eegtreeNoPhSmear ->SetMCEleEneSmear( 0.016, 0.028 );
  ...
  eegtreeNoPhSmearNoEleSmear ->SetDoMuonChannel(false); 
