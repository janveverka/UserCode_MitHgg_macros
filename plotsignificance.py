...
EXPfile = ROOT.TFile("smrelpsig.root")
OBSfile = ROOT.TFile("smrelpobs.root")
BOBSfile = ROOT.TFile("smrelpsig125.root")
...
#leg=ROOT.TLegend(0.42,0.15,0.87,0.40)
leg=ROOT.TLegend(0.52,0.12,0.87,0.25)
leg.SetFillColor(0)
leg.SetBorderSize(0)
...
leg.AddEntry(graphBObs,"1xSM Higgs 125 GeV","L")
...
mytext.DrawLatex(133,1.6,"#splitline{CMS preliminary}{#sqrt{s} = 7 TeV L = 4.76 fb^{-1}}")
...
C.SaveAs("pvaluesm.pdf")
C.SaveAs("pvaluesm.eps")
#C.SaveAs("test.eps")
